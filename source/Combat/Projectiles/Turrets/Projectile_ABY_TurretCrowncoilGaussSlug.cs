...
{
    public class Projectile_ABY_TurretCrowncoilGaussSlug : Bullet
    {
        ...
        protected override void Tick()
        {
            ...
            {
                CrowncoilGaussVfxUtility.SpawnTravelSpark(currentPosition, Map);
            }
        ...
        protected override void Impact(Thing hitThing, bool blockedByShield = false)
        {
            ...
            if (!ABY_ProjectileImpactSafetyUtility.TryRunBaseImpact(this, hitThing, "Projectile_ABY_TurretCrowncoilGaussSlug", () => base.Impact(hitThing, blockedByShield)))
            {
                return;
            }
            ...
            CrowncoilGaussVfxUtility.SpawnImpact(impactPosition, impactDirection, impactMap, blockedByShield);
        }
    }
}
