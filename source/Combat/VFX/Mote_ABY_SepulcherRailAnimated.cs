...
{
    public class Mote_ABY_SepulcherRailAnimated : Thing
    {
        public string framePathPrefix = "Things/VFX/SepulcherRail/ABY_SepulcherRailImpact_";
        public int frameCount = 8;
        public int ticksPerFrame = 1;
        public int ticksLeft = 8;
        public int startingTicks = 8;
        public float drawSizeX = 1.05f;
        public float drawSizeZ = 1.05f;
        ...
        {
            base.ExposeData();
            Scribe_Values.Look(ref framePathPrefix, "framePathPrefix", "Things/VFX/SepulcherRail/ABY_SepulcherRailImpact_");
            ...
            Scribe_Values.Look(ref drawSizeX, "drawSizeX", 1.05f);
            Scribe_Values.Look(ref drawSizeZ, "drawSizeZ", 1.05f);
