...
{
    public class Mote_ABY_PlasmaLanceAnimated : Thing
    {
        public string framePathPrefix = "Things/VFX/PlasmaLance/ABY_PlasmaLanceImpact_";
        public int frameCount = 8;
        public int ticksPerFrame = 1;
        public int ticksLeft = 8;
        public int startingTicks = 8;
        public float drawSizeX = 0.96f;
        public float drawSizeZ = 0.96f;
        ...
        {
            base.ExposeData();
            Scribe_Values.Look(ref framePathPrefix, "framePathPrefix", "Things/VFX/PlasmaLance/ABY_PlasmaLanceImpact_");
            ...
            Scribe_Values.Look(ref drawSizeX, "drawSizeX", 0.96f);
            Scribe_Values.Look(ref drawSizeZ, "drawSizeZ", 0.96f);
