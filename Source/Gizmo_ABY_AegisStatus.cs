...
namespace AbyssalProtocol
{
    ...
    ///
    /// It is intentionally UI-only: no action, no ticking, no combat logic.
    /// Combat interception remains in Apparel_ABY_ArmorAegis / CompABY_WornArmorAegisTracker.
    /// </summary>
    public class Gizmo_ABY_AegisStatus : Gizmo
    {
        ...
        public Gizmo_ABY_AegisStatus(string label, string subtitle, string state, string points, string tooltip, string theme, float current, float max, bool suppressed, bool collapsed, Texture2D icon)
        {
        ...
        {
            Rect iconFrame = new Rect(rect.x + 8f, rect.y + 30f, 34f, 34f);
        ...
        private void DrawText(Rect rect, Palette palette)
        {
            ...
            Widgets.Label(new Rect(rect.x + 10f, rect.y + 3f, rect.width - 20f, 18f), label.ToUpperInvariant());
        ...
        {
            Rect barBack = new Rect(rect.x + 48f, rect.y + 62f, rect.width - 58f, 7f);
        ...
        private readonly struct Palette
        {
            ...
            public readonly Color stateText;
            public readonly Color iconBack;

            public Palette(Color back, Color header, Color border, Color borderDark, Color fill, Color fillTop, Color title, Color dim, Color text, Color iconBack)
            {
                this.back = back;
                this.header = header;
                this.border = border;
