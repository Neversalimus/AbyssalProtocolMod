...
namespace AbyssalProtocol
{
    public static class AbyssalDominionBalanceUtility
    {
        ...
        public static RuntimeProfile BuildProfile(Map map, MapComponent_DominionCrisis crisis)
        {
            ...
            profile.StageTier = Mathf.Clamp(Mathf.Max(colonistTier, wealthTier) + profile.ReplayTier, 0, 6);
            ...
            profile.MaxActiveHostiles = Mathf.Clamp(14 + profile.Colonists + profile.StageTier * 2 + (crisis?.CompletionCount ?? 0), 16, 34);
            ...
            profile.AmbientContaminationMultiplier = Mathf.Clamp((0.94f + profile.StageTier * 0.035f) * (profile.LowFxMode ? 0.92f : 1f), 0.85f, 1.18f);
