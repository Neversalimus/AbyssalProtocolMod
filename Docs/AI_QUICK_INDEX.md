...
| Sigil use, ritual activation, circle modules/capacitors | `source/Summoning/` | `source/Defs/Summoning/`, `source/UI/Summoning/`, `Defs/ThingDefs/`, `Defs/RecipeDefs/`; normal carrier movement/held-sigil timing is owned by `source/Summoning/Jobs/JobDriver_CarrySigilToAbyssalCircle.cs` |
