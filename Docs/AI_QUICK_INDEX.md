...
| Summon blocked / valid-circle false positive / stale encounter lock / player diagnostic report | `source/Summoning/ABY_SummonPreflightReport.cs`, `source/Summoning/MapComponents/MapComponent_ABY_SummonEncounterRuntime.cs`, `source/Bosses/Shared/AbyssalBossSummonUtility.cs` | `source/World/Buildings/Summoning/Building_AbyssalSummoningCircle.cs`, `source/UI/Summoning/AbyssalSummoningConsoleUtility.cs`, `source/Diagnostics/ABY_SummonThreatRehearsalUtility.cs`, `source/Core/GameComponents/MapComponent_AbyssalPortalWave.cs`, `source/Dominion/MapComponents/MapComponent_DominionCrisis.cs` |
| Sigil consumed / ritual aborted / refund / carried-sigil warmup / operator route | `source/Summoning/ABY_SigilInvocationTransaction.cs`, `source/Summoning/ABY_SigilUseValidator.cs`, `source/Summoning/Jobs/JobDriver_CarrySigilToAbyssalCircle.cs` | `source/Bosses/Shared/Comps/CompUseEffect_SummonBoss.cs`, `source/World/Buildings/Summoning/Building_AbyssalSummoningCircle.cs`, `source/UI/Summoning/` |
| Concurrent Dev encounter lifecycle records | `source/Summoning/MapComponents/MapComponent_ABY_SummonEncounterRuntime.cs` | `source/Diagnostics/ABY_SummonThreatRehearsalUtility.cs`, `source/Bosses/Shared/AbyssalBossSummonUtility.cs` |
| Capacitor exemption policy / no reflection mutation | `source/Summoning/AbyssalCircleCapacitorRitualUtility.cs` | `source/Compatibility/MapComponent_AbyssalProgressionHotfix.cs` |
| Rift Butcher post-horde miniboss, severance core, Dominion pre-gate | `source/Comps/CompABY_RiftButcherCombat.cs`, `source/Progression/ABY_HordeAndButcherProgressionGameComponent.cs`, `source/UI/Summoning/AbyssalSummoningConsoleUtility.cs` | `Defs/ThingDefs/ABY_RiftButcher_Content.xml`, `Defs/PawnKindDefs/ABY_RiftButcher_PawnKinds.xml`, `Defs/HediffDefs/ABY_RiftButcher_Hediffs.xml`, `Defs/RecipeDefs/ABY_RiftButcher_Recipes.xml`, `Textures/Pawn/RiftButcher/` |
...
| Stateful melee weapons / Crown Interdictor / Dominion Breach Driver / Crown Scission Array | `source/Combat/Comps/CompABY_CrownInterdictor.cs`, `source/Combat/DamageWorkers/DamageWorker_ABY_CrownInterdictorTrigger.cs`, `source/Combat/Comps/CompABY_DominionBreachDriver.cs`, `source/Combat/DamageWorkers/DamageWorker_ABY_DominionBreachSequence.cs`, `source/Combat/Comps/CompABY_CrownScissionArray.cs`, `source/Combat/DamageWorkers/DamageWorker_ABY_CrownScissionEcho.cs` | `Defs/ThingDefs/ABY_CrownInterdictor.xml`, `Defs/DamageDefs/ABY_CrownInterdictor_DamageDefs.xml`, `Defs/HediffDefs/ABY_CrownInterdictor_Hediffs.xml`, `Defs/ThingDefs/ABY_DominionBreachDriver.xml`, `Defs/DamageDefs/ABY_DominionBreachDriver_DamageDefs.xml`, `Defs/ThingDefs/ABY_CrownScissionArray.xml`, `Defs/DamageDefs/ABY_CrownScissionArray_DamageDefs.xml`, `WeaponTweakData/`, `Textures/Things/Weapon/`, `Languages/` |
...
- Circle slot management lives in the selected-ritual card's Circle Infrastructure callout and the nested infrastructure window. The infrastructure window should stay as a compact one-screen slot manager: capacitor lattice, stabilizer ring, short effect summary.
