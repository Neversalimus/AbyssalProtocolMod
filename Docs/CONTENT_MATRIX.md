...
### Turret module tier ownership note

As of the turret module rebalance, existing modules are distributed as:

- T1 Signal: Rift Needler Core, Cooling Lattice, Blackout Power Regulator, Targeting Sigil.
- T2 Breach: Plasma Lance Core, Ash Choir Repeater Core, Choir Arc Emitter, Residue Capacitor, Overpressure Cycle Governor, Long Choir Lens, Breach Aegis Relay.
- T3 Archon: Cinder Mortar Core, Abyssal Harpoon Projector, Rift Flak Bloom, Close-Quarters Interlock, Anti-Swarm Pattern Scanner, Execution Logic Core.
- T4 Reactor: Vesper Lance Array, Sanctified Prism Emitter, Null-Arc Discharger, Shield-Burn Capacitor, Sanctified Stabilizer Plate, Emergency Heat Dump, Abyssal Threat Prioritizer.
- T5 Dominion: Crowncoil Gauss Minigun, Sepulcher Rail Core, Crownfire Rocket Choir, Crown Aegis Matrix.

Recipe gates should use Crafting 7/8/10/12/14 for T1/T2/T3/T4/T5 turret modules.
